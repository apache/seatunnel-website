...
This local deployment guide assumes that you use the official SeaTunnel 2.3.13 binary release package. If you need to validate source changes, debug SeaTunnel source code, or prepare a custom distribution, see [Set Up Develop Environment](../../developer/setup.md).
