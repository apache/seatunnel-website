...
If you need to install connectors plugin manually, you need to pay special attention to the following
...
If you want to install the V2 connectors plugin manually, you only need to download the V2 connectors plugin you need and put them in the seatunnel directory
