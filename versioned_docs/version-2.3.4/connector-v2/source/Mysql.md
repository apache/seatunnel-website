...
> Please download the support list corresponding to 'Maven' and copy it to the '$SEATNUNNEL_HOME/lib/' working directory<br/>
> For example Mysql datasource: cp mysql-connector-java-xxx.jar $SEATNUNNEL_HOME/lib/
