...
3. **错误码** → 查阅[错误快速参考手册](./Error-Quick-Reference-Manual.md)。
4. **仍未解决？** → 搜索 [GitHub Issues](https://github.com/apache/seatunnel/issues) 或通过[邮件列表](https://lists.apache.org/list.html?dev@seatunnel.apache.org)联系社区。
